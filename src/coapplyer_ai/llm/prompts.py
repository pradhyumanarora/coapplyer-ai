...
determine_section_template = """You are assisting a bot designed to automatically apply for jobs on CoApplyer AI. The bot receives various questions about job applications and needs to determine the most relevant section of the resume to provide an accurate response.
...
- **Examples**: Email address, phone number, CoApplyer AI profile, GitHub repository, personal website.
