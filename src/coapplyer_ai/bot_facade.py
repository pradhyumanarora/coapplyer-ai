...
class CoApplyerAIBotState:
    def __init__(self):
        logger.debug("Initializing CoApplyerAIBotState")
        self.reset()

    def reset(self):
        logger.debug("Resetting CoApplyerAIBotState")
    ...
    def validate_state(self, required_keys):
        logger.debug(f"Validating CoApplyerAIBotState with required keys: {required_keys}")
